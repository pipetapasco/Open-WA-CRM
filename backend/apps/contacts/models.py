...
class Contact(TimeStampedModel):
    ...
    phone_number = models.CharField(
        max_length=20,
        db_index=True,
        help_text='Número de teléfono con código de país (ej: 573001234567)'
    )
    ...
    profile_picture_url = models.URLField(
        ...
        blank=True,
        null=True,
        help_text='URL de la foto de perfil de WhatsApp'
    )
    metadata = models.JSONField(
        default=dict,
        blank=True,
        help_text='Información adicional del contacto'
    )
